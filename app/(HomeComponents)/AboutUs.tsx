  ...
  return (
    <section className="w-full mt-[4%] flex flex-col items-center ">
      ...
      {home && (
        <Link
          href="/about"
          className={`${bebas.className} bg-sugar text-black px-2 py-[1px] w-[25%] rounded-xl text-center mt-[0.8rem] text-sm flex items-center justify-center md:w-[20%] md:py-1 md:text-xl md:rounded-3xl lg:w-[16%] lg:text-3xl lg:mt-5`}
        >
          Learn More
        </Link>
      )}
